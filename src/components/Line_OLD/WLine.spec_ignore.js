...
//     xit(`Should be render correctly with dots`, () => {
...
//     xit(`Should be render correctly with 3 dots`, () => {
//         const wrapper = shallowMount(WLine, dotConfig)
//         expect(wrapper.findAll(WDot)).toHaveLength(3)
//     })

//     xit(`Should be render correctly with area`, () => {
...
//     xit(`Should be render correctly with custom color area `, () => {
//         const customConfig = { ...defaultConfig, propsData: { ...defaultConfig.propsData, area: true, styles: { fill: 'red' } } }
//         const wrapper = shallowMount(WLine, customConfig)
//         expect(wrapper.html()).toMatchSnapshot()
//     })

//     xit(`Should be render correctly without dot`, () => {
//         const wrapper = shallowMount(WLine, defaultConfig)
//         expect(wrapper.vm.dotsData).toEqual([])
//     })

//     xit(`Should be render correctly with custom fillColor`, () => {
...
//     xit(`Should be render correctly with curve and bool`, () => {
...
//     xit(`Should be render correctly with curve and func`, () => {
...
//         })
//         xit('It emits the mouseleave event', () => {
//             const wrapper = mount(WLine, defaultConfig)
