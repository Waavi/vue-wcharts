    ...
    .add('Custom', () => ({
        ...
        data () {
            ...
            return {
                ...
                valueY1: number('Y1', 1500, {
                    range: true,
                    min: 1000,
                    max: 3000,
                }),
                valueY2: number('Y2', 2700, {
                    range: true,
                    min: 1000,
                    max: 3000,
                }),
                bs0: number('BorderSpacing (index 0)', 0, {
                    range: true,
                    min: 0,
                    max: 100,
                }),
                ...
                bs2: number('BorderSpacing (index 2)', 0, {
                    range: true,
                    min: 0,
                    max: 100,
                }),
            ...
            <div class="Container">
                ...
                >
                    ...
                    <WMarker
                        :x="[valueX1, valueX2]"
                        :y="[valueY1, valueY2]"
                        :borderSpacing="[bs0, bs1 / 100, bs2, bs3 / 100]"
                        :styles="styles"
                        #default="{ x, y, width, height, styles }"
                    >
                        <g :transform="'translate('+x+', '+y+')'">
                            ...
                            <text
                                ...
                                text-anchor="middle"
                                :transform="'translate('+(width / 2)+', '+(height / 2)+') rotate(-20)'"
                            >
                                This is my marker!
                            </text>
                        </g>
